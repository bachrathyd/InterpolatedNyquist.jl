...
Section~\ref{sec:performance}, four refinement levels from a $30\times30$
mesh trace the boundary at a $480\times480$-equivalent resolution in
$0.3$\,s (Table~\ref{tab:gridtimings}) -- more than an order of magnitude
below the cost of a brute-force grid of that density.
