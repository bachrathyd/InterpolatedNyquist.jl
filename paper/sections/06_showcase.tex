...
\begin{figure}[tb]
  ...
  Table~\ref{tab:tolerance}.}\label{fig:tolerance}
\end{figure}
...
\begin{table}[tb]
  ...
  statistics and the number of grid points where the rounded count would be
  ambiguous ($\varepsilon\ge1/4$).}\label{tab:tolerance}
...
buys \emph{certainty}, not appearance, and not a single grid point is
misclassified even at the loosest setting (Table~\ref{tab:tolerance}).
