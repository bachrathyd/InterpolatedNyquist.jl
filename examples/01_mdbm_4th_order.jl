...
GLMakie.closeall()
GLMakie.activate!(; title="Hybrid Stability - 4th Order System")
...
# 2. Hybrid Strategy Part 1: Coarse Grid Sweep for Background
...
ax = GLMakie.Axis(f[1, 1], title="4th Order System Stability", xlabel="P", ylabel="D")
...
save("output_figures/example_01.png", f)
display(f)
